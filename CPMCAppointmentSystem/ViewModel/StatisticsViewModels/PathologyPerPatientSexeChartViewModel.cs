...
namespace CPMCAppointmentSystem.ViewModel.StatisticsViewModels
{
    public class PathologyPerPatientSexeChartViewModel : StatisticsChartsViewModelBase
    {
        ...
        public PathologyPerPatientSexeChartViewModel(IFrameNavigationService mainFrameNavigationService, IInnerFrameNavigationService innerFrameNavigationService)
